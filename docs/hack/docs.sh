...
sphinx-apidoc -f -e -o docs/source/apidoc/ Final_Project_Squad1/
...
sed -i '0,/Final_Project_Squad1/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//Final_Project_Squad1/' docs/source/index.rst
# Generate html docs
make -C docs/ html
