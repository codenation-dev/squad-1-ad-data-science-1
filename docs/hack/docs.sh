...
sphinx-apidoc -f -e -o docs/source/apidoc/ recommender_system_squad_1/
...
sed -i '0,/recommender_system_squad_1/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//recommender_system_squad_1/' docs/source/index.rst
# Generate html docs
make -C docs/ html
